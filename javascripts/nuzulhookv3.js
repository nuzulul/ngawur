...
function loadScript()
{
var likebutton = '<div id="nuzulhook_box"><div id="likefbatas"><a href="http://facebook.com/nuzululzulkarnainhaq/">facebook</a></div></div><div id="nuzulhook_box"><div  id="tweets">Tweets</div></div>';
var left_sidebar = '<div id="nuzulhook_sidebar">' + likebutton + document.getElementById('templatemo_left_sidebar').innerHTML + '<div id="nuzulhook_sidebar_bottom">'+ document.getElementById('templatemo_right_sidebar').innerHTML + '<div id="nuzulhook_box"><div id="histats_count"></div></div> </div></div>';
...
datautama.getElementsByTagName("a")[4].innerHTML = 'Copyright © '+n+' Nuzulul Zulkarnain Haq. All rights reserved.<div id="nuzulhook_share"></div><a href="#disqus_thread">Lihat</a>';
...
var datautama = document.getElementById('nuzulhook_content');
datautama.getElementsByTagName("a")[1].innerHTML = '<a href="http://nuzulul-fkp09.web.unair.ac.id/artikel_detail-24176.html">Nuzulul Zulkarnain Haq</a>';
datautama.getElementsByTagName("a")[4].innerHTML = 'Copyright © '+n+' Nuzulul Zulkarnain Haq. <a href="">Lihat</a>';
...
datautama.getElementsByTagName("a")[11].innerHTML = 'Copyright © '+n+' Nuzulul Zulkarnain Haq. <a href="">Lihat</a>';
...
datautama.getElementsByTagName("a")[18].innerHTML = 'Copyright © '+n+' Nuzulul Zulkarnain Haq. <a href="">Lihat</a>';
...
datautama.getElementsByTagName("a")[25].innerHTML = 'Copyright © '+n+' Nuzulul Zulkarnain Haq. <a href="">Lihat</a>';
...
datautama.getElementsByTagName("a")[32].innerHTML = 'Copyright © '+n+' Nuzulul Zulkarnain Haq. <a href="">Lihat</a>';
