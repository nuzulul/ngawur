...
function loadScript()
{
var footer = '<div id="nuzulhook_footer"><center>'+footertext+'</br>Powered by <a href="http://goo.gl/uyiYiR" target="_blank">Elegan Theme</a></center></div><head><link rel="shortcut icon" type="image/x-icon" href="'+favicon+'" /></head><style>body {background:#000 url("'+background+'") repeat fixed center center;}</style>';
...
RunSlideShow("GambarDasar","GambarBackground",sliderurl,5);
}
