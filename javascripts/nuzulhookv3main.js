...
function loadScript()
{
var livechat = '<div class="nuzulhook_box"><a href="http://nuzulul-fkp09.web.unair.ac.id/artikel_detail-24186.html"><h2>Buku Tamu - Live Chat</h2></a><div id="livechat"><a href="http://nuzulul-fkp09.web.unair.ac.id/artikel_detail-24186.html">Buku Tamu</a></div></div>';
var likebutton = '<div id="nuzulhook_box"><div id="likefbatas"><a href="http://facebook.com/bangnuzul/">facebook</a></div></div><div id="nuzulhook_box"><div  id="tweets"></div></div>';
var left_sidebar = '<div id="nuzulhook_sidebar"><div id="nuzulhook_sidebar_top"></div>' + likebutton + document.getElementById('templatemo_left_sidebar').innerHTML + ''+ document.getElementById('templatemo_right_sidebar').innerHTML + '<div id="histats_count"></div><div id="nuzulhook_sidebar_bottom"></div></div>';
...
document.getElementById('templatmeo_wrapper').outerHTML= '<div id="nuzulhook_wrapper"><div id="nuzulhook_header_wrapper"></div><div id="nuzulhook_header"><div id="nuzulhook_header_top_all"></div><div id="nuzulhook_header_top"><img id="nuzulhook_header_top_image" style="opacity: 0;" src="http://nuzulul.github.io/img/headerkampuscunair.jpg" width="100px"><div id="nuzulhook_header_top_trans"></div><div id="nuzulhook_header_top_line"></div><div id="nuzulhook_header_top_search"></div></div><div id="nuzulhook_header_bottom"></div><div id="nuzulhook_header_poto"><a href="http://nuzulul-fkp09.web.unair.ac.id"><img src="http://nuzulul.github.io/img/image-profil-nuzulul-2.jpg" width="100%"></a><div id="nuzulhook_header_poto_border"></div></div><div id="nuzulhook_header_title"><h2><a href="http://nuzulul-fkp09.web.unair.ac.id">Nuzulul Official Blog</a></h2><h3>A Hybrid Nurse & Blogger Faculty of Nursing Airlangga University</h3><div id="liketwitteratas"><a href="http://twitter.com/bangnuzul/">twitter</a></div></div><div id="nuzulhook_header_menu"> ' + menupopup1 + medsos + '</div> </div><div id="nuzulhook_content_wrapper"><div id="nuzulhook_content_top_all"></div>' + content + '</div><div id="nuzulhook_footer_top_all"></div><div id="nuzulhook_footer"> '+ foot +'</div></div>';
...
document.getElementById('likefbatas').innerHTML = "<div id=\"likefbatas\"><iframe src=\"https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fnuzululzh%2F&tabs&width=330&height=130&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=false&appId=109267179132135\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; width:340px; height:140px;padding:5px 5px;\" allowTransparency=\"true\"><\/iframe><\/div>";
...
var tag = document.createElement("script");
tag.src = "https://cse.google.com/cse/brand?form=cse-search-box&lang=id";
document.getElementsByTagName("body")[0].appendChild(tag);
...
datautama.getElementsByTagName("a")[29].innerHTML = '<a href="http://nuzulul-fkp09.web.unair.ac.id/artikel_detail-24176.html">Nuzulul Zulkarnain Haq</a>';
datautama.getElementsByTagName("a")[32].innerHTML = 'Copyright (c) '+n+' Nuzulul Zulkarnain Haq. <a href="">Lihat</a>';
datautama.getElementsByClassName('templatemo_box')[0].outerHTML = '<div class="templatemo_box">' + datautama.getElementsByClassName('templatemo_box')[0].innerHTML + '</div>';
datautama.getElementsByClassName('templatemo_box')[1].outerHTML = '<div class="templatemo_box">' + datautama.getElementsByClassName('templatemo_box')[1].innerHTML + '</div>';
datautama.getElementsByClassName('templatemo_box')[2].outerHTML = '<div class="templatemo_box">' + datautama.getElementsByClassName('templatemo_box')[2].innerHTML + '</div>';
datautama.getElementsByClassName('templatemo_box')[3].outerHTML = '<div class="templatemo_box">' + datautama.getElementsByClassName('templatemo_box')[3].innerHTML + '</div>';
datautama.getElementsByClassName('templatemo_box')[4].outerHTML = '<div class="templatemo_box">' + datautama.getElementsByClassName('templatemo_box')[4].innerHTML + '</div>';
var datautama = datautama.innerHTML;
document.getElementById('nuzulhook_content').innerHTML = '<div id="nuzulhook_content"><div id="nuzulhook_content_top"></div>' + datautama + '<div id="feed"></div><div id="nuzulhook_content_bottom"></div></div><style>#nuzulhook_content .hide {height: 32px; overflow: hidden;}#nuzulhook_content .hide:hover {height:100%}object {width:100%;height:650px;}</style>';
document.getElementById("nuzulhook_content_top").innerHTML= document.getElementById("addhomedata").innerHTML;
}

document.getElementById("nuzulhook_header_wrapper").innerHTML= document.getElementById("nuzulhook_header_wrapper_content").innerHTML;
document.getElementById("nuzulhook_header_top_all").innerHTML= document.getElementById("nuzulhook_header_top_all_content").innerHTML;
document.getElementById("nuzulhook_content_top_all").innerHTML= document.getElementById("nuzulhook_content_top_all_content").innerHTML;
document.getElementById("nuzulhook_footer_top_all").innerHTML= document.getElementById("nuzulhook_footer_top_all_content").innerHTML;
document.getElementById("nuzulhook_sidebar_top").innerHTML= document.getElementById("nuzulhook_sidebar_top_content").innerHTML;
